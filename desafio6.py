...
#crear el campo conversionRate

cr=df_difcero['soldQuantity']/df_difcero['visits']
df_difcero=df_difcero.assign(conversionRate=cr.values)

#ordenando por conversion rate
df_difcero=df_difcero.sort_values(by=['conversionRate'],ascending=False)

#indexando la creacion del campo conversion ranking



df_difcero.reset_index(inplace=True)

df_difcero["conversionRanking"]=df_difcero.index
